  ...
  (function(namespace){
      ...
      */
      ...
      namespace.bro_upload = function(settings) {
          var debug = true;
          ...
          function Uploader(settings) {
              ...
              u.file  = settings.file;
							// partition will keep file partition that is in progress
							u.partition;
              ...
              settings.on_chunk_uploaded = settings.on_chunk_uploaded || function() {};
							settings.on_resume_upload = settings.on_resume_upload   || function() {};
							settings.on_new_upload = settings.on_new_upload         || function() {};
          ...
          Uploader.prototype.start = function() {
	                ...
	                alert("No file selected");
							...
							return this.upload_file(this.file, false);
						}
          };
                      ...
                      if(!u.upload_id) {
                          AmazonXHR.init(json, u.settings.key, file, function(e) {
                              ...
                              u.load_file();
															...
															u.settings.on_new_upload.call(u, json);
                          });
                      } else {
                          ...
                          if(!force) {
                              ...
                              AmazonXHR.list(u.auth, u.file, u.settings.key, u.upload_id, u.settings.chunk_size, function(parts) {
                                  ...
                                  u.load_file();
																	...
																	u.settings.on_resume_upload.call(u, json);
                              }, function() {
          ...
          Uploader.prototype.log_status = function() {
              // log(this.get_total_progress() / this.file.size * 100);
					...
					Uploader.prototype.get_partition = function() {
          ...
          Uploader.prototype.on_chunk_uploaded = function(f) { this.settings.on_chunk_uploaded = f; };
					Uploader.prototype.on_resume_upload = function(f) { this.settings.on_resume_upload = f; };
					Uploader.prototype.on_new_upload = function(f) { this.settings.on_new_upload = f; };
      ...
      AmazonXHR.prototype = {
          send: function(callback) {
              ...
              var date_string = [
                  self.settings.auth.date.getFullYear(),
                  utils.zfill(self.settings.auth.date.getMonth() + 1, 2),
                  utils.zfill(self.settings.auth.date.getDate(), 2)
              ].join('');
